...
import { BCEDatePartMatchIndex, fromYear_BCEDateIndex, toYear_BCEDateIndex, BCEEventTextMatchIndex, BCE_START_REGEX, fromYearNotation_BCEDateIndex, toYearNotation_BCEDateIndex, } from "../regex.js";
import { DateRangePart, RangeType, } from "../Types.js";
import { roundDateUp, getYearNotationToDatetime } from "./utils.js";
export function getDateRangeFromBCEDateRegexMatch(line, i, lengthAtIndex, context) {
    ...
    const BCEFromYearNotation = eventStartLineRegexMatch[fromYearNotation_BCEDateIndex] ||
