 ...
 */
export function checkMarkdownSection(lines, i, lengthAtIndex, context) {
    const line = lines[i];
    ...
    const { properties, i: end, propOrder, range: propRange, } = parseProperties(lines, lengthAtIndex, i + 1, context);
 ...
 */
function parseMarkdownSection(titleText, range) {
